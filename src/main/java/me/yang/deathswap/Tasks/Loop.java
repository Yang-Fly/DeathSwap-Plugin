...
public class Loop extends BukkitRunnable {
    ...
    public void run() {
        ...
        if (game_state == 0) {
            ...
            if (greenDeaths == 1) {
                new End(plugin, bluePlayerName, greenPlayerName);
            } else if (blueDeaths == 1) {
                new End(plugin, greenPlayerName, bluePlayerName);
            }
